    ...
    public partial class LoginWindow : Window
    {
        ...
        private async void btnLogin_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                File.WriteAllText("owmeta_oauth_token.json", JsonConvert.SerializeObject(tokenResponse));
            ...
            {
                MessageBox.Show(
                    $"Login failed: {ex.Message}\n\nPlease make sure you're using the correct credentials for your OWMETA account.",
                    "Error",
                    MessageBoxButton.OK,
        ...
        {
            Process.Start(new ProcessStartInfo("https://owmeta.io/signup")
            {
